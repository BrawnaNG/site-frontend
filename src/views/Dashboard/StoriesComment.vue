<template>
  <div class="stories-comment-page">
    ...
    <user-menu />
    <div class="row stories-comment-page-content mx-auto py-5">
      <div class="row pb-2">
        <h2 class="mx-2 px-4">
          Comments
        </h2>
    ...
    <div class="row comments-stories-content p-0">
      <div
...
export default {
  name: "StoriesComment",
  components: {CommentsCard,BreadCrumbs,UserMenu,AddStory},
  data() {
    return {
      addReply: false,
      commentList: {
