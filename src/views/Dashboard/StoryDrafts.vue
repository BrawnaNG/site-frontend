<template>
  <div class="story-drafts-page">
    <b-col cols="10" class="story-drafts-page-head mx-auto py-3">
    ...
    <b-col cols="10" class="story-drafts-page-content mx-auto py-5">
