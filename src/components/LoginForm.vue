<template>
  <div class="p-3">
    <div class="login-form" v-if="view === 'login'">
      ...
      <div class="login-form-sub-title text-center">
        Haven't any account?
        <span class="cursor-pointer" @click="view = 'signup'">
          Sign up here.
        </span>
      </div>
    </div>
    <div class="login-form" v-if="view === 'signup'">
      <div class="p-1 rounded border">
        <b-form-input v-model="signUp.alias"
                      class="border-0 login-form-input"
      ...
      <b-row class="p-1 m-0 rounded border mt-3">
        <b-col cols="10" class="px-0">
          <b-form-input v-model="signUp.rePassword"
                        :type="showRepeatPassword ? 'text' : 'password'"
                        class="border-0 login-form-input"
                        placeholder="Repeat Password"/>
        </b-col>
        <b-col cols="2" class="text-right pr-2 pt-1">
          <img title="show password" @click="showRepeatPassword = !showRepeatPassword " class="cursor-pointer" src="../assets/image/icon/Show.svg">
        </b-col>
      </b-row>
      ...
      <div class="login-form-sub-title text-center">
        Are you a member?
        <span class="cursor-pointer" @click="view = 'login'">Login here</span>
      </div>
